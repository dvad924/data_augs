...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
		...
		--shuffle \
		$TRAIN_DATA_ROOT \
		$METADATA/person_vs_background_vs_random_train.txt \
		$EXAMPLE/person_vs_background_vs_random_256_train_lmdb
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
		...
		--shuffle \
		$TEST_DATA_ROOT \
		$METADATA/person_vs_background_vs_random_test.txt \
		$EXAMPLE/person_vs_background_vs_random_256_test_lmdb
