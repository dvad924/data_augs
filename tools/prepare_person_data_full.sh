...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
		...
		--shuffle \
		$TRAIN_DATA_ROOT \
		$METADATA/person_vs_backgroundonly_train.txt \
		$EXAMPLE/person_background_only_train_lmdb
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
		...
		--shuffle \
		$TEST_DATA_ROOT \
		$METADATA/person_vs_backgroundonly_test.txt \
		$EXAMPLE/person_background_only_test_lmdb
